...
public class fillings extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(fillings.this, 1);
        recyclerView.setLayoutManager(gridLayoutManager);

        AlertDialog.Builder builder = new AlertDialog.Builder(fillings.this);
        ...
        adapter = new MyAdapter(fillings.this, dataList);
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        for (DocumentSnapshot doc : task.getResult()) {
                            ...
                            if (dataClass != null && containsIgnoreCase(dataClass.getTreatment(), "Fillings")) {
