...
public class Implants extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_implants);
        ...
        GridLayoutManager gridLayoutManager = new GridLayoutManager(Implants.this, 1);
        recyclerView.setLayoutManager(gridLayoutManager);

        AlertDialog.Builder builder = new AlertDialog.Builder(Implants.this);
        ...
        adapter = new MyAdapter(Implants.this, dataList);
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        for (DocumentSnapshot doc : task.getResult()) {
                            ...
                            if (dataClass != null && containsIgnoreCase(dataClass.getTreatment(), "Implants")) {
