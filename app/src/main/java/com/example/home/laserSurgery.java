...
public class laserSurgery extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_laser_surgery);

        firestore = FirebaseFirestore.getInstance();

        recyclerView = findViewById(R.id.recyclerViewlaser);

        searchView = findViewById(R.id.search);
        searchView.clearFocus();

        GridLayoutManager gridLayoutManager = new GridLayoutManager(laserSurgery.this, 1);
        recyclerView.setLayoutManager(gridLayoutManager);

        AlertDialog.Builder builder = new AlertDialog.Builder(laserSurgery.this);
        ...
        adapter = new MyAdapter(laserSurgery.this, dataList);
                ...
                .addOnCompleteListener(task -> {
                    if (task.isSuccessful()) {
                        ...
                        for (DocumentSnapshot doc : task.getResult()) {
                            ...
                            if (dataClass != null && containsIgnoreCase(dataClass.getTreatment(), "Laser Surgery")) {
